...
export class ProductService{
    ...
    private adminresetdetails : any=[
        {
            adminID:1,
            adminEmail:"simarkaur0302@gmail.com",
            adminPass:"simakaur"
        }
    ]
    ...
    // getAdmin(id:number):any{
    //     const oldadmin = this.adminresetdetails.find(
    //         x => x.adminID === id
    //     )
    //     return oldadmin;
    // }

    // updateAdmin(adminInfo:any){
    //     let oldadmin = this.adminresetdetails.find(x=>x.adminID === adminInfo.adminID);
    //     oldadmin.adminEmail = adminInfo.adminEmail;
    //     oldadmin.adminPass = adminInfo.adminPass;
    //     this.toaster.warning('Password Changed','Alert',{timeOut:2000});
